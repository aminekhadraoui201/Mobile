...
public class AfficherDossier extends AppCompatActivity {
    ...
    private void addRowToTable(DossierMedicale dossier) {
        ...
        lastnameTextView.setText(dossier.getLastname());
        addressTextView.setText(dossier.getAddress());
        bloodTypeTextView.setText(dossier.getBloodType());
        maladieTextView.setText(dossier.getMaladie());
        phoneNumberTextView.setText(dossier.getPhoneNumber());
